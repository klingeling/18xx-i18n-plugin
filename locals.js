...
I18N.zh["homepage"] = { // 主页翻译
    "static": { // 静态翻译
        ...
        "In multiplayer games, you'll also be able to make moves for other players, this is so people can say 'pass me this SR' and you don't need to wait. To use this feature in a game, enable \"Master Mode\" in the Tools tab. Please use it politely!": "在多人模式中, 你还可以替代其他玩家行动, 这样玩家就可以说\"我结束这个股票轮\", 而不需要花时间等待。要在游戏中使用此功能, 请在\"工具\"选项卡中启用\"主机模式\"。请礼貌地使用它!",
...
I18N.zh["new_game"] = { // 创建新游戏页面翻译
    "static": { // 静态翻译
        ...
        "Volatility Expansion: 13 additional private companies and a modified initial auction": "多样性扩展: 13 家新增的私有公司和一个修改过的初始拍卖",
        "": "",
        "": "",
        "": "",
        "": "",
...
I18N.zh["game"] = { // 游戏页面翻译
    "static": { // 静态翻译
        ...
        "Auto pass in Stock Round": "自动结束股票轮",
        "Auto pass in Investment Phase": "自动结束投资阶段",
        "Auto pass in Stock Round (Enabled)": "自动结束股票轮 (已启用)",
        "Auto pass in Investment Phase (Enabled)": "自动结束投资阶段 (已启用)",
        "Auto pass in Closing Round": "自动结束停业轮",
        "Auto pass in Closing Round (Enabled)": "自动结束停业轮 (已启用)",
        "Automatically pass in the Stock Round. This will deactivate itself if other players do actions that may impact you. It will only pass on your normal turn and allow you to bid etc.": "自动地结束股票轮。如果其他玩家做出可能影响你的行为, 这将使其自身失效。它只会结束你的正常回合, 并允许你出价等行动。",
        "Automatically pass in the Investment Phase. It will only pass on your normal turn and will still allow you to bid etc.": "自动地结束投资阶段。它只会结束你的正常回合, 并允许你出价等行动。",
        "Automatically pass in the close companies phase. This will persist from turn to turn. It will deactivate itself when you control a company with negative income, unless configured not do so.": "自动地结束停业轮。这将在每个回合中持续。当你控制一家收入为负的公司时, 它会自行禁用, 除非配置它不这样。",
        ...
        "share(s)": "股",
        "Switch to auto-pass after successful completion.": "成功完成后切换到自动结束。",
        "Enable": "启用",
        "Disable": "禁用",
        "Update": "更新",
        "Pass even if other players do actions that may impact you.": "即使其他玩家做出可能影响你的行为, 也要结束。",
        "Continue passing in future Stock Rounds as well.": "在之后的股票股票轮中继续保持自动结束。",
        "Continue passing in future Investment Phases as well.": "在之后的投资阶段中继续保持自动结束。",
        "Continue to pass even when one of your companies has negative income": "即使你的一家公司的收入为负, 也继续保持自动结束",
        "Discard Trains": "弃置火车",
        "Discard Train": "弃置火车",
        ...
        "Hide Companies": "隐藏公司",
        "Choose": "选择",
        "-- Programmed action 'Pass in Stock Round' removed due to round change": "-- 由于轮次更改, 程序动作 \"结束股票轮\" 已移除",
        "Accept": "接受",
        "Reject": "拒绝",
        "1 right": "1 →",
        "2 right": "2 →",
        ...
        "Payoff Loans": "偿还贷款",
        "Offer for Sale": "提供出售",
        "Pass (Offer for Sale)": "结束 (提供出售)",
        "Pass (Subsidiaries)": "结束 (子公司)",
        "Bid Power": "竞拍力",
        ...
        // Rolling Stock Stars
        "Doppler AG": "多普勒集团",
        "Junkyard Scrappers": "废品收购集团",
        "Overseas Trading": "海外贸易集团",
        "Prussian Railway": "普鲁士铁路集团",
        "Synergistic": "协同集团",
        "Stars, Inc.": "星星集团",
        "Stock Masters": "股票大师集团",
        "Vintage Machinery": "复古机械集团",
        "Range": "范围",
        "Foreign Investor": "外国投资者",
        "Corporation closes": "股份公司关闭",
        "Offering": "提供",
        "Remaining Deck": "牌库剩余",
        "Current Cost of Ownership": "当前拥有成本",
        "Target Stars by Share Price": "按股价划分的目标星级",
        "Max stock price in phase 1 or 7 or end card flipped in phase 7": "在阶段 1 或 7 达到最大股价, 或者在阶段 7 开始时结束卡牌已被翻开",
        "Level": "等级",
        "Target": "目标",
        "Unissued": "未发行",
        "No cost of ownership": "无拥有成本",
        "Investment": "投资",
        "Investment Round": "投资轮",
        "New cost of ownership: None": "新的拥有成本: 无",
        "New cost of ownership: Red = $1": "新的拥有成本: 红色 = $1",
        "New cost of ownership: Red = $2": "新的拥有成本: 红色 = $2",
        "New cost of ownership: Red, Orange = $3": "新的拥有成本: 红色, 橙色 = $3",
        "New cost of ownership: Red, Orange = $4": "新的拥有成本: 红色, 橙色 = $4",
        "New cost of ownership: Red, Orange, Yellow = $6": "新的拥有成本: 红色, 橙色, 黄色 = $6",
        "New cost of ownership: Red, Orange, Yellow = $7": "新的拥有成本: 红色, 橙色, 黄色 = $7",
        "New cost of ownership: Red, Orange, Yellow, Green = $10": "新的拥有成本: 红色, 橙色, 黄色, 绿色 = $10",
        "New cost of ownership: Red, Orange, Yellow, Green = $16": "新的拥有成本: 红色, 橙色, 黄色, 绿色 = $16",
	    "(Market)": "(市场)",
        "Wrap-Up": "小结",
        "Acquisition": "收购",
        ...
        "End card flipped : Game Ends on next phase 7": "结束卡牌被翻开 : 游戏在下一阶段 7 结束",
        "End card flipped": "结束卡牌被翻开",
        ...
        "Game ends: Game end card reached": "游戏结束: 游戏结束卡牌已被翻开",
        "Corp:": "公司:",
        "Price:": "价格:",
        "Offer": "报价",
        ...
        "+$1 Per Company": "+$1 每拥有一家公司",
        "+$1 Per Two Synergy Markers": "+$1 每两个协同标记",
        "Advantage Buying From Foreign Inv.": "优先与外国投资者进行交易",
        "Cost of Ownership Reduced Up to $10": "拥有成本最高可降低 $10",
        "No Price Change When Issuing a Share": "发行股票不会改变股价",
        "Bonus When Closing Companies": "关闭公司获得奖励",
        "Double Income for Best Company": "最好公司双倍收入",
        "Receives +$1 for each company it owns": "每拥有一家公司可获得 +$1",
        "Always has first priority trading with the Foreign Investor (as if its share price is higher than any other), and only pays face value rather than the maximum allowed price.": "始终优先与外国投资者进行交易(就好像其股价高于任何其他投资者一样), 并且只用支付面值而不是最高允许价格。",
        "Always adds 2 addtional ★s to its ★ count": "始终在 ★ 的计数中添加 2 颗额外的 ★",
        "Cost of ownership is reduced by up to $10 (but not below $0)": "拥有成本最高可降低 $10 (但不低于 $0)",
        "When issuing a share, its share price does not change": "当发行股票时, 其股价不会改变",
        "When it closes a company, it receives twice the printed income of that company as a scrapping bonus": "当它关闭一家公司时，它将获得该公司印刷收入的两倍作为报废奖励",
        "Receives +$1 for every two synergy markers it owns (rounded down)": "每拥有两个协同标记就获得 +$1 (向下取整)",
        "Doubles printed income of its best company": "将其最好公司的印刷收入翻倍",
        "Stars": "星星",
        "Company Revenue:": "公司收入:",
        "Synergies:": "协同效应:",
        "Cost of Ownership:": "拥有成本:",
        "Ability Income:": "能力收入:",
        "(Empty)": "(空)",
    ...
    "regexp": [ // 正则翻译
        ...
        [/^(.*) auctions (.*) for (.+\d+)$/, function (all, username, company, number) {
            var company_zh = (I18N.zh["game"]["static"][company] ? I18N.zh["game"]["static"][company] : company);
            return username + " 以 " + number + " 开始拍卖 " + company_zh;
        }],
        ...
        [/^(.*) wins bid and buys (.*) for (.+\d+)$/, function (all, username, company, number) {
            var company_zh = (I18N.zh["game"]["static"][company] ? I18N.zh["game"]["static"][company] : company);
            return username + " 赢得竞标并花费了 " + number + " 购买 " + company_zh;
        }],
        ...
        // "-- Enabled programmed action 'Pass in Stock Round, unconditionally'": "-- 已启用程序行动 \"无条件地结束股票轮\"",
        // "-- Enabled programmed action 'Pass in Stock Round, unconditionally, indefinitely'": "-- 已启用程序行动 \"无条件, 无限期地结束股票轮\"",
        // "-- Enabled programmed action 'Pass in Stock Round, indefinitely'": "-- 已启用程序行动 \"无限期地结束股票轮\"",
        // "-- Disabled programmed action 'Pass in Stock Round, unconditionally' due to 'user'": "-- 由于 \"玩家\" 原因, 已禁用程序行动 \"无条件地结束股票轮\"",
        // "-- Disabled programmed action 'Pass in Stock Round, unconditionally, indefinitely' due to 'user'": "-- 由于 \"玩家\" 原因, 已禁用程序行动 \"无条件, 无限期地结束股票轮\"",
        // "-- Disabled programmed action 'Pass in Stock Round, indefinitely' due to 'user'": "-- 由于 \"玩家\" 原因, 已禁用程序行动 \"无限期地结束股票轮\"",
        [/^-- (Enabled|Disabled) programmed action 'Pass in Stock Round(, unconditionally|, indefinitely|, unconditionally, indefinitely|)'(?: due to '(user|(?:Corporation (.+) parred))'|)$/, function (all, able, description, reason, company) {
            ...
            return "--" + reason + " 已" + (able === "Enabled" ? "启用": "禁用") + "程序行动 \"" + description + "结束股票轮\""
        }],
        [/^-- (Enabled|Disabled) programmed action 'Pass in Closing Round(, unconditionally|, indefinitely|, unconditionally, indefinitely|)'(?: due to '(user|(?:Corporation (.+) parred))'|)$/, function (all, able, description, reason, company) {
            ...
            return "--" + reason + " 已" + (able === "Enabled" ? "启用": "禁用") + "程序行动 \"" + description + "结束停业轮\""
        }],
        ...
        [/Submit (.+\d+)$/, "提交 $1"],
        [/ operates /, " 运营 "],
        [/ has no valid actions and passes$/, " 没有有效行动因此结束行动"],
        [/ passes$/, " 结束行动"],
        [/Value: (.*\d*)/, "价值: $1"],
        [/Price: (.*\d*)/, "价格: $1"],
        [/Revenue: (.*\d*)/, "收入: $1"],
        ...
        [/ passes buy companies$/, " 结束购买公司"],
        [/ skips buy companies$/, " 跳过购买公司"],
        [/ passes lay track$/, " 结束铺设轨道"],
        ...
        [/ passes place a token or lay track$/, " 结束放置一个车站或铺设轨道"],
        ...
        [/^token cost: (.*\d+)$/, "车站代价: $1"],
        [/^Foreign Investor receives (.*\d+)$/, "外国投资者 收到 $1"],
        ...
        [/^(.+) passes buy\/use companies$/, "$1 结束购买/使用公司"],
        ...
        [/^Seed Money for initial auction is (.+\d+)$/, "为初始拍卖提供的种子资金是 $1"],
        [/^(.+) wins the auction for (.+) with a bid of (.+\d+) spending (.+\d+) seed money, (.+\d+) seed money remains$/, function (all, user, company, money, bank, remain) {
            var company_zh = (I18N.zh["game"]["static"][company] ? I18N.zh["game"]["static"][company] : company);
            return user + " 以 " + money + " 的出价赢得 " + company_zh + " 的拍卖, 花费了 " + bank + " 种子资金, 种子资金还剩余 " + remain;
        }],
        [/^(.+) must choose city for home token$/, "$1 必须为初始车站选择一个城市"],
        [/^(.+) wins bid on (.+) for (.+\d+)$/, "$1 以 $3 赢得 $2 的竞标"],
        ...
        [/^(.+) cannot bid (.+\d+) and is out of the auction for (.+)/, function (all, user, money, company) {
            var company_zh = (I18N.zh["game"]["static"][company] ? I18N.zh["game"]["static"][company] : company);
            return user + " 由于无法出价 " + money + ", 退出对 " + company_zh + " 的拍卖"; 
        }],
        ...
        [/^(.+) \(in receivership\) pays (.+\d+) per share$/, "$1 (处于接管中) 每股支付 $2"],
        ...
        [/ receives (.+\d+) as a scrapping bonus$/, " 收到 $1 作为报废奖励"],
        [/^(.+ \(.+\)) closes$/, "$1 关闭"],
        [/^Pass (\(.+\))$/, "结束 $1"],
        [/^Close (.+)$/, "关闭 $1"],
        [/^(.+) acts for (.+)$/, "$1 代表 $2"],
        [/ skips issue share$/, " 跳过发行股票"],
        [/ passes issue share$/, " 结束发行股票"],
        [/ controls no corporations and must pass$/, " 没有控制任何股份公司因此必须结束"],
        [/ has no more legal actions and must pass$/, " 没有更多合法行动因此必须结束"],
        [/^(.+) acquires (.+) from Foreign Investor for (.+\d+)$/, "$1 花费 $3 从外国投资者收购 $2"],
        ...
        [/^(.+) passes choose a corporation to ipo$/, function (all, company) {
            var company_zh = (I18N.zh["game"]["static"][company] ? I18N.zh["game"]["static"][company] : company);
            return company_zh + " 结束选择一家公司进行 IPO"
        }],
        [/^(.+) converts to a corporation: (.+)$/, function (all, private, company) {
            var company_zh = (I18N.zh["game"]["static"][company] ? I18N.zh["game"]["static"][company] : company);
            return private + " 转换为一家股份公司: " + company_zh;
        }],
        ...
        [/ passes propose, accept or reject acquisition offers$/, " 结束提议, 接受或拒绝收购要约"],
        [/^Buy Market Share \((.+\d+)\)/, "购买市场股票 ($1)"],
        [/ pays (.+\d+) due to net loss/, " 因净亏损支付 $1"],
        [/^President's share sold to pool\. (.+) enters receivership$/, "总裁股被出售至市场池。$1 进入接管程序"],
        [/^(.+) bankrupts$/, "$1 破产倒闭"],
        [/^Will (.+ \(.+\)) purchase (.+) \(Foreign Investor\) for (.+\d+)\?$/, "$1 会以 $3 的价格收购 $2 (外国投资者) 吗？"],
        [/^(.+) has the right to intervene$/, "$1 有权干预"],
        [/^(.+) proposes to purchase (.+) from the Foreign Investor for (.+\d+)$/, "$1 计划以 $3 的价格从外国投资者购买 $2"],
