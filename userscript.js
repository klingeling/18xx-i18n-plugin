...
// @require      https://github.moeyy.xyz/https://raw.githubusercontent.com/klingeling/18xx-i18n-plugin/locals.js
// @run-at       document-end
...
(function (window, document, undefined) {
    ...
    function fetchTranslatedText(key) {
        ...
        // if (page !== 'homepage' && !key.match(I18N.conf.keyClass) && !key.match(I18N.conf.userCompanyClass)) {
        //     console.log(key);
        // }
